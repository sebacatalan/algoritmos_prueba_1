    ...
    if matriz[1][2]==0 and matriz[1][3]==0:#en la segunda fase se busca que se hgan 0 en x1 y x2 en la fila z
        if b<0 and b!=matriz[1][-1]:#aqui digo que si el numero mas negativo es menor a 0 se siga ejecutando, pero si tambien debe ser distinto del LD
            ...
            break
                    ...
                    # hacemos una copia de la matriz con las soluciones, así podremos trabajar iterando sobre la fila z, es decir Matriz[1]
                    piv = matriz
                    funi = piv[1]
                    print("-------La restricción más rentable--------")
                    # print(funi)
                    # Esta función sirve para encontar tanto el valor como el índice de, este caso, la restricción más factible.
